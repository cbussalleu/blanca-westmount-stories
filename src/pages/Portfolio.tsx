      ...
      <main>
        ...
        <section className="py-16">
          <div className="container-narrow">
            <div className="flex flex-wrap gap-2 mb-12">
              {filters.map(filter => (
                <button
                  ...
                  className={`text-xs font-westmount tracking-widest uppercase px-4 py-2 border border-black transition-colors ${activeFilter === filter ? "bg-black text-[hsl(var(--pastel-yellow))]" : "bg-transparent text-black hover:opacity-60"}`}
                >
                  {filter}
                </button>
              ))}
            ...
            <div className="portfolio-cases-grid" style={{
              display: 'grid',
              ...
              {filteredProjects.map((project) => (
                <Link
                  ...
                  onMouseLeave={e => e.currentTarget.style.background = 'hsl(var(--pastel-yellow))'}
                >
                  <div style={{
            ...
            <style>{`
              @media (max-width: 640px) {
                .portfolio-cases-grid { grid-template-columns: 1fr !important; }
              }
            `}</style>
          </div>
        </section>
