          ...
          <div className="hero-wrap">
            ...
            <div style={{ paddingTop: 'var(--s-6)' }}>
              <h1 style={{
                ...
                margin: '0 0 var(--s-5)'
              }}>No Silver<br/><em style={{ fontFamily: "'westmount-outline', serif", fontStyle: 'normal', fontWeight: 'normal', letterSpacing: '0.04em' }}>Bullets.</em></h1>
              <p style={{
                ...
                A mindset, not a method. Complex service problems resist simple solutions.
              </p>
            </div>
          </div>
        </section>
