          ...
          <div className="container-narrow">
            <div className="max-w-3xl mx-auto">
              ...
              <motion.div
                ...
                className="mb-16"
              >
                <p className="font-westmount font-light text-[11px] tracking-[0.22em] uppercase text-gray-500 mb-4">How I work with AI</p>
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-westmount font-light leading-[0.92] tracking-[-0.02em] mb-8">AI IN SERVICE DESIGN</h1>
              ...
              >
                ...
                <div>
                  <p className="font-westmount font-light text-[11px] tracking-[0.22em] uppercase text-gray-500 mb-2">Knowledge Architecture</p>
                  ...
                  <p className="font-westmount font-light text-[11px] tracking-[0.22em] uppercase text-gray-400 mb-2">Challenge</p>
                  ...
                  <p className="font-westmount font-light text-[11px] tracking-[0.22em] uppercase text-gray-400 mb-2">What I did</p>
                  <ul className="font-merriweather text-[15px] leading-[1.65] text-gray-700 mb-4 space-y-2">
                  ...
                  <p className="font-westmount font-light text-[11px] tracking-[0.22em] uppercase text-gray-400 mb-2">Result</p>
                  <p className="font-merriweather text-[15px] leading-[1.65] text-gray-700 mb-4">
                  ...
                  <p className="font-westmount font-light text-[11px] tracking-[0.22em] uppercase text-gray-400 mb-2">Tools</p>
              ...
              >
                ...
                <div>
                  <p className="font-westmount font-light text-[11px] tracking-[0.22em] uppercase text-gray-500 mb-2">Process Automation</p>
              ...
              >
                ...
                <div>
                  <p className="font-westmount font-light text-[11px] tracking-[0.22em] uppercase text-gray-500 mb-2">Internal Tooling</p>
              ...
              <motion.div
                ...
                className="mb-16 border-t border-gray-400 pt-12"
              >
                <p className="font-westmount font-light text-[11px] tracking-[0.22em] uppercase text-gray-500 mb-4">A note on approach</p>
                <p className="font-merriweather text-[15px] leading-[1.65] text-gray-700">
              ...
              >
                ...
                <Link to="/methodology" className="inline-flex items-center font-westmount font-light text-[11px] tracking-[0.2em] uppercase hover:opacity-60 transition-opacity">
